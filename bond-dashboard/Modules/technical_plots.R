        ...
        if(tolower(indicator_type) == "volatility") {
            ...
            p2 <- ggplot(tech_data, aes(x = date)) +
                ...
                theme(
                    ...
                    plot.subtitle = element_text(size = 10.5, color = "#666"),
            ...
            p3 <- ggplot(tech_data, aes(x = date)) +
                ...
                theme(
                    plot.title = element_text(face = "bold", size = 12),
                    plot.subtitle = element_text(size = 10.5, color = "#666"),
                    plot.caption = element_text(size = 9, color = "#666", hjust = 0),
                    axis.text = element_text(size = 9),
                    axis.title = element_text(size = 10)
                )
...
generate_signal_matrix_heatmap <- function(data) {
    ...
    p <- ggplot(signal_scores_long, aes(x = indicator, y = bond, fill = color_category)) +
        ...
        # TOTAL column left border separator (thick for visual emphasis)
